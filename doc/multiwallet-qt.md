...
In order to support loading of multiple wallets in clash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is clash.cpp.
...
Changes to clash.cpp
----------------------
clash.cpp is the entry point into clash-qt, and as such, will require some minor modifications to provide hooks for
