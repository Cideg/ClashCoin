...
RESOURCES += src/qt/clash.qrc src/qt/clash_locale.qrc

TRANSLATIONS += src/qt/locale/clash_bg.ts \
                src/qt/locale/clash_de.ts \
                src/qt/locale/clash_en.ts \
                src/qt/locale/clash_es.ts \
                src/qt/locale/clash_fi.ts \
                src/qt/locale/clash_fr.ts \
                src/qt/locale/clash_it.ts \
                src/qt/locale/clash_ja.ts \
                src/qt/locale/clash_pl.ts \
                src/qt/locale/clash_pt.ts \
                src/qt/locale/clash_ru.ts \
                src/qt/locale/clash_sk.ts \
                src/qt/locale/clash_sv.ts \
                src/qt/locale/clash_vi.ts \
                src/qt/locale/clash_zh_CN.ts \
                src/qt/locale/clash_zh_TW.ts
