...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CLH features */
        {"clash", "masternode", &masternode, true, true, false},
        {"clash", "masternodelist", &masternodelist, true, true, false},
        {"clash", "mnbudget", &mnbudget, true, true, false},
        {"clash", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"clash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"clash", "mnsync", &mnsync, true, true, false},
        {"clash", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"clash", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use clashd, or the -server option to clash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> clash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33000/\n";
}
