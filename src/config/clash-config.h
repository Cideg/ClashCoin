/* src/config/clash-config.h.  Generated from clash-config.h.in by configure.  */
/* src/config/clash-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "http://bit.clashs"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CLH Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CLH Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "clash"
