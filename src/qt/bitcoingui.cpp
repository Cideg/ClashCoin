                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Clash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CLH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and clash: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CLH Core"), this);
    aboutAction->setStatusTip(tr("Show information about CLH Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CLH"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CLH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CLH addresses"));
    ...
    openAction->setStatusTip(tr("Open a CLH: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CLH Core help message to get a list with possible CLH command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CLH Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CLH network", "", count));
}
...
{
    QString strTitle = tr("CLH Core"); // default title
