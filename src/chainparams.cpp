...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 2 * 60; // CLH: 1 day
        nTargetSpacing = 2 * 60;  // CLH: 1 minute
        nLastPOWBlock = 4000;
        nMaturity = 7;
    ...
    //     vSeeds.push_back(CDNSSeedData("54.37.235.13", "54.37.235.13"));
      ...
      vSeeds.push_back(CDNSSeedData("Seednode1", "207.148.28.107"));
        ...
        nStartMasternodePayments = 1524845562;
    }
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // CLH: 1 day
        nTargetSpacing = 1 * 60;  // CLH: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet CLH BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet CLH BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet CLH BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // CLH: 1 day
        nTargetSpacing = 1 * 60;        // CLH: 1 minutes
